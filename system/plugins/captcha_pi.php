...
{		
   ...
   if ($word == '')
   {
	...
	$bg_color		= imagecolorallocate ($im, 64, 224, 208);
	$border_color	= imagecolorallocate ($im, 153, 102, 102);
	$text_color		= imagecolorallocate ($im, 18, 10, 143);
  ...
  //echo  $bg_color;
	...
	$img = "<img src=\"$img_url$img_name\" width=\"$img_width\" height=\"$img_height\" alt=\"captcha\" style=\"border:0;\" alt=\" \" />";
